  ...
  async function getResume() {
    ...
    await axios
      ...
      .then((res) => {
        ...
        setExperiences(res.data.resume.experience);
              ...
              {experiences?.map((experience) => (
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <small className="">{experience?.location}</small>
                  </div>
            ...
            {isAddExperience && (
              <form className="mt-7" onSubmit={() => {}}>
                <div className="flex flex-col justify-between gap-x-20 align-middle w-full">
                  ...
                  <div className="w-full flex items-center justify-end relative my-2 gap-x-2">
                    <input
                      className="bg-cosretBlue-300 px-8 text-black text-sm focus:outline-none border-[0.5px] border-[#323232] rounded-lg"
                      id="endDate"
                      type="checkbox"
                      name="endDate"
                      value={present}
