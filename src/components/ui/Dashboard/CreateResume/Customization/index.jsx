  ...
  async function getResume() {
    ...
    await axios
      ...
      .then((res) => {
        ...
        setFont(res.data?.resume?.font ?? "");
        setLetterSpacing(res.data?.resume?.letterSpacing ?? "");
        setFontSize(res.data?.resume?.fontSize ?? "");
        setPrimaryColor(res.data?.resume?.primaryColor ?? "");
        setSecondaryColor(res.data?.resume?.secondaryColor ?? "");
              ...
              <form className="mt-7" onSubmit={() => {}}>
                <div className="">
                  <div className="flex flex-col justify-between gap-x-20 align-middle w-full">
                    <div className="flex items-center flex-wrap xl:flex-nowrap justify-between gap-x-6">
